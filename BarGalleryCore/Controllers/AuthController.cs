...
using BGCommon.Models.Response;
using BGCommon.Models.Request;
using BGCommon.Constants;
using BGCommon.Models.Manager;

namespace AdaptiveStoreAdmin.Controllers
{
    public class AuthController : BaseController
    {
        private IIdentityManager _identityManager;
        public AuthController(UserManager<User> userManager, SignInManager<User> signInManager, ILogger<AuthController> logger, IIdentityManager identityManager)
