...
namespace BGDataLayer.DAL
{
    ...
    {
        protected BGContext _dbContext;
        public BaseRepository(BGContext dbContext)
        {
        ...
        public void CompanyUpdateModel(T entity, params Expression<Func<T, object>>[] updatedProperties)
        {
            var dbEntityEntry = _dbContext.Entry(entity);
